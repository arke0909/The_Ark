...
{
    public class HealTurnState : State
    {
        private float WAIT_SEC = 1;

        public HealTurnState(TurnManager turnManager, GameEventChannel turnChangeChannel, string stateName) : base(turnManager, turnChangeChannel, stateName)
        {
        }
